...
public class SystemLogger implements Logger {
  ...
  public void trace(String msg) {
    logStore.writeLog(Level.TRACE, scopeName, pid, msg);
  ...
  public void trace(String msg, @Nullable Throwable t) {
    logStore.writeLog(Level.TRACE, scopeName, pid, appendThrowable(msg, t));
  ...
  public void debug(String msg) {
    logStore.writeLog(Level.DEBUG, scopeName, pid, msg);
  ...
  public void debug(String msg, @Nullable Throwable t) {
    logStore.writeLog(Level.DEBUG, scopeName, pid, appendThrowable(msg, t));
  ...
  public void info(String msg) {
    logStore.writeLog(Level.INFO, scopeName, pid, msg);
  ...
  public void info(String msg, @Nullable Throwable t) {
    logStore.writeLog(Level.INFO, scopeName, pid, appendThrowable(msg, t));
  ...
  public void warn(String msg) {
    logStore.writeLog(Level.WARN, scopeName, pid, msg);
  ...
  public void warn(String msg, @Nullable Throwable t) {
    logStore.writeLog(Level.WARN, scopeName, pid, appendThrowable(msg, t));
  ...
  public void error(String msg) {
    logStore.writeLog(Level.ERROR, scopeName, pid, msg);
  ...
  public void error(String msg, @Nullable Throwable t) {
    logStore.writeLog(Level.ERROR, scopeName, pid, appendThrowable(msg, t));
